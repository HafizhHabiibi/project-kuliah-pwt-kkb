<div class="bg-[#FAFBFC]">
  <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800" style="box-shadow: 0 8px 20px 2px rgba(0, 0, 0, 0.25);">
            ...
            <div class="lg:pl-20">
              ...
              <div class="flex flex-wrap items-center gap-4">
                <button wire:click='addToCart({{ $product->id }})' class="w-full p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
                  <span wire:loading.remove wire:target='addToCart({{ $product->id }})'>Tambah Keranjang</span><span wire:loading wire:target='addToCart({{ $product->id }})'>Menambahkan....</span></button>
              </div>
            </div>
          </div>
        </div>
