...
<header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full py-7" style="background-color: white; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
  <nav class="relative max-w-7xl w-full flex flex-wrap md:grid md:grid-cols-12 basis-full items-center px-4 md:px-6 md:px-8 mx-auto">
    ...
    <div class="flex items-center gap-x-1 md:gap-x-2 ms-auto py-1 md:ps-6 md:order-3 md:col-span-3">
      <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-xl bg-white border border-[#FFD700] text-[#FFD700] hover:border-[#ACCDFF] hover:text-[#ACCDFF] focus:outline-none focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:hover:bg-white/10 dark:text-white dark:hover:text-white dark:focus:text-white">
        Masuk
      </button>
      <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-xl border border-transparent bg-[#ACCDFF] text-black hover:bg-[#FFD700] focus:outline-none focus:bg-lime-500 transition disabled:opacity-50 disabled:pointer-events-none">
        Daftar
      </button>
    ...
    <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:justify-center md:items-center md:gap-y-0 md:gap-x-7 md:mt-0">
      ...
      <div>
        <a wire:navigate 
          ...
          <span>Cart</span>
          <span class="py-0.5 px-1.5 rounded-full text-xs font-medium bg-yellow-50 border border-yellow-200 text-yellow-600">4</span>
        </a>
      </div>
    </div>
  </div>
