<!-- ========== FOOTER ========== -->
<footer class="mt-auto w-full max-w-[100rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto" style="background-color: white;">
  <!-- Grid -->
  <div class="text-center">
    <div>
      <a class="flex-none text-xl font-semibold text-black dark:text-white" href="#" aria-label="Brand">Bharata</a>
    </div>
    <!-- End Col -->
