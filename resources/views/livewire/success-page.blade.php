  ...
  <div class="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto bg-white border rounded-md dark:border-gray-900 dark:bg-gray-900 md:py-10 md:px-10">
    <div>
      <h1 class="px-4 mb-8 text-2xl font-semibold tracking-wide text-gray-700 dark:text-gray-300 ">
        Terimakasih sudah order, admin akan menghubungin anda! </h1>
        ...
        <div class="flex items-start justify-start flex-shrink-0">
          <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
            <div class="flex flex-col items-start justify-start space-y-2">
              ...
              <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{ $order->address->alamat }}</p>
              <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{ $order->address->kabkota}}, {{ $order->address->provinsi}}, {{ $order->address->kode_pos}}</p>
              <p class="text-sm leading-4 cursor-pointer dark:text-gray-400">No Telepon : {{ $order->address->phone }}</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="flex items-center justify-center space-x-2">
                ...
                <div class="flex flex-col items-center justify-start">
                  <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">
                    Diantarkan<br><span class="text-sm font-normal">Diantarkan maksimal 24 jam setelah order</span>
                  </p>
                </div>
              </div>
            </div>
